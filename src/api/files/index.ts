 ...
 * @returns
 */
export const getFileList: filesApis["getFileList"] = (isAlbum?: number) => {
 ...
 * @returns
 */
export const isExistFolder: filesApis["createFolder"] = (foldername: string, folderId: number) => {
    return LinRequest.request({
        url: "/files/isExistFolder",
        method: "get",
        params: { foldername, folderId },
    });
};
 ...
 * @returns
 */
export const downloadFile: filesApis["downloadFile"] = (
    id: number,
